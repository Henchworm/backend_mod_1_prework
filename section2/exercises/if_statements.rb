...
puts "Let's see if I can buy a gumball. How many quarters do I have?"
puts "Type number of quarters:"
...
puts "Let's see if I can make a pizza."
puts "How much flour to I have? Type # of cups below:"
cups_of_flour = gets.chomp
puts "Do I have sauce? Type true or false below."
